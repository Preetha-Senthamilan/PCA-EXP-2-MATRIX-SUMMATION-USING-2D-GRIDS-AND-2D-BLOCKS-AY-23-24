...
![image](https://github.com/Preetha-Senthamilan/PCA-EXP-2-MATRIX-SUMMATION-USING-2D-GRIDS-AND-2D-BLOCKS-AY-23-24/assets/119390282/9ef81102-1f5b-41d9-8dae-00a70db9cc43)


## RESULT:
The host took 22.5100000 seconds to complete it’s computation, while the GPU outperforms the host and completes the computation in 0.000000 seconds. Therefore, float variables in the GPU will result in the best possible result. Thus, matrix summation using 2D grids and 2D blocks has been performed successfully.
